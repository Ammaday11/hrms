                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <a href="{{route('create_roster', ['month' => $currentMonth, 'year' => $currentYear])}}" class="text-right mb-3 btn btn-info">Create Roster</a>
                                <a href="{{route('edit_roster', ['month' => $currentMonth, 'year' => $currentYear])}}" class="text-right mb-3 btn btn-warning">Modify Roster</a>
                                <a href="#" class="text-right mb-3 btn btn-danger" data-toggle="modal" data-target="#exampleModal">Delete Roster</a>
                            </div>
                        </div>
                        <!-- ============================================================== -->
                        <!-- data table  -->
                        ...
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <form class="ml-auto w-auto" action="{{ route('show_roster')}}"  data-parsley-validate="" method='POST' enctype="multipart/form-data">
                                    @csrf
                                    <div class="input-group date mb-1" id="datetimepicker11" data-target-input="nearest">
                                        <input type="text" value="{{ $currentMonth ,$currentYear }}" name="roster_month_date"  class="form-control datetimepicker-input" data-target="#datetimepicker11" />
                                        <div class="input-group-append" data-target="#datetimepicker11" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="far fa-calendar-alt"></i></div>
                                        </div>
                                        <button type="submit" class="btn btn-space btn-info mt-auto mb-auto ml-2">GO!</button>
                                    </div>
                                </form>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Delete Roster - {{ \Carbon\Carbon::createFromDate(date('Y'), $currentMonth, 1)->format('F') }} {{$currentYear}}</h5>
                                        <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </a>
                                    </div>
                                    <div class="modal-body">
                                        <p>Are you sure you want to delete the roster for {{ \Carbon\Carbon::createFromDate(date('Y'), $currentMonth, 1)->format('F') }} {{$currentYear}}</p>
                                    </div>
                                    <div class="modal-footer">
                                        <a href="{{route('delete_roster', ['month' => $currentMonth, 'year' => $currentYear])}}" class="btn btn-danger">Confirm</a>
