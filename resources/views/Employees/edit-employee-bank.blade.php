                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header">
                                    <h3 class="mb-2">Edit Employee Bank Information</h3>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" style="margin: auto">
                                    <div class="card">
                                        <h5 class="card-header">Edit {{$employee->fname}}'s Bank Information</h5>
                                        <div class="card-body">
                                            <form action="{{ route('update_employee_bank', ['id' => $employee->id])}}"  data-parsley-validate="" method='POST' enctype="multipart/form-data">
                                                @if ($errors->any())
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" name="bank_name" required="" value="{{ old('bank_name', $employee->bank_name) }}" placeholder="Bank Name" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label  for="bank_acc_name">Bank Acc Name</label>
                                                    <input  type="text" name="bank_acc_name" required="" value="{{ old('bank_acc_name', $employee->bank_acc_name) }}" placeholder="Bank Acc Name" class="form-control">
                                                </div><div class="form-group">
                                                    <label  for="bank_acc">Account Number</label>
                                                    <input  type="text" name="bank_acc" required="" value="{{ old('bank_acc', $employee->bank_acc) }}" placeholder="Account Number" class="form-control">
                                                </div>
                                                <div class="row">
