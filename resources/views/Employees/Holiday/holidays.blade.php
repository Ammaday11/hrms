                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="{{route('create-holiday')}}" class="btn btn-info">+ Add Holiday</a>
                                    </div>
                                    @if ($errors->any())
                                                ...
                                                <tbody>
                                                    @foreach($holidays as $holiday)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('edit_holiday', ['id' => $holiday->id])}}" class="btn btn-brand btn-sm m-r-10 fas fa-edit" ></a>
                                                                <a href="{{route('delete_holiday', ['id' => $holiday->id])}}" class="btn btn-danger btn-sm m-r-10 fas fa-trash"></a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
