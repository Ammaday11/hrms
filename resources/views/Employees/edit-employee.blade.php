                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" style="margin: auto">
                                    <div class="card">
                                        <h5 class="card-header">Edit {{$employee->fname}}'s Information</h5>
                                        <div class="card-body">
                                            <form action="{{ route('update_employee', ['id' => $employee->id]) }}"  data-parsley-validate="" method='POST' enctype="multipart/form-data">
                                                @if ($errors->any())
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" name="employeeID" readonly value="{{ old('employeeID', $employee->employeeID) }}" placeholder="Employee ID" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label  for="fname">First Name</label>
                                                    <input  type="text" name="fname" required="" value="{{ old('fname', $employee->fname) }}" placeholder="First Name" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label  for="lname">Last Name</label>
                                                    <input  type="text" name="lname"  required="" value="{{ old('lname', $employee->lname) }}" placeholder="Last Name" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                                        <input type="text" name="joined_date" value="{{ old('joined_date', $employee->joined_date) }}" class="form-control datetimepicker-input" data-target="#datetimepicker4" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="department_id" class="form-control custom-select" id="department-select">
                                                        <option value="{{ old('department_id', $employee->department_id) }}" selected="" >{{$employee->department->name}}</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="designation_id" class="form-control custom-select" id="designation-select">
                                                        <option value="{{ old('designation_id', $employee->designation_id) }}"  selected >{{$employee->designation->designation}}</option>
                                                    </select>
                                                </div>
