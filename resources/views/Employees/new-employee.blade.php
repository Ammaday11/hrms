                                ...
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="">
                                        <div class="form-group">
                                            <label  for="roomNumber">Employee ID</label>
                                            <input data-parsley-type="number" type="text" required="" placeholder="Employee ID" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label  for="roomNumber">Full Name</label>
                                            <input data-parsley-type="number" type="text" required="" placeholder="Full Name" class="form-control">
                                        </div>
                                        <div class="form-group">
